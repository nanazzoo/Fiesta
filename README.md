...
- **구현 기능**
  ...
  - 좋아요, 북마크
  - 댓글 작성 및 삭제(대댓글)
  - AJAX를 이용한 비동기 좋아요 수 숨기기, 댓글 기능 사용 안함
  - 언급 및 해시태그 자동 완성
...
- **성과**: 
  - 웹소켓을 사용하여 알림기능을 구현할 수 있습니다.
  - ajax를 이용하여 비동기 무한 스크롤을 구현할 수 있습니다.
...
[추천 멤버 선정 기준 수정](https://github.com/FiestaUpdate/Fiesta/issues/17)
